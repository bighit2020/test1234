package jpubs.ch24.ex2.edit;
import java.sql.*;
//args[0],args[1]값을 넣는다.(2,3)
public class PlsqlProcedure {
  public static void main(String[] args) throws SQLException   {
    ...
    CallableStatement cs = conn.prepareCall("{ call compute_power(?, ?, ?) }"); //2번째를 IN으로만 설정 변경된 형태
   ...
   // cs.registerOutParameter(2, Types.INTEGER);----------------------------------------------------------edit
